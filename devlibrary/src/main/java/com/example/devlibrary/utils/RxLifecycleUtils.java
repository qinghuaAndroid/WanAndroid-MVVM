...
import com.example.devlibrary.lifecycle.ActivityLifecycleable;
import com.example.devlibrary.lifecycle.FragmentLifecycleable;
import com.example.devlibrary.lifecycle.Lifecycleable;
...
public class RxLifecycleUtils {
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindUntilEvent(@NonNull IView view,
                                                             ActivityEvent event) {
