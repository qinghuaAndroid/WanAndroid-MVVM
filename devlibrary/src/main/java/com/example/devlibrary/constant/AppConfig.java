package com.example.devlibrary.constant;
...
public class AppConfig {
    ...
    public static final String WX_APP_ID = "wx5d61901c46df9014";
    public static final String WX_APP_SECRET = "5953b7bce03c76ddf1ce678944278774";
    ...
    public static final String MINAPP_USERNAME = "gh_d468922b5c91";  //小程序Id
    public static final String PATH = "pages/index/index"; //小程序首页
    public static final String DYNAMIC_PATH = "pages/dynamicDetail/index?from=appShare&bid="; //小程序动态详情页
    public static final String GOOD_PATH = "pages/goodDetail/goodDetail?from=appShare&bid="; //小程序商品详情页
    public static final String INVITE_CODE = "inviteCode=";  //添加邀请code
