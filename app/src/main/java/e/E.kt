 ...
 */
@AndroidEntryPoint
class E : BaseVMActivity<BK, ActivityMyArticleBinding>() {

    private val articleViewModel by viewModels<BK>()
    private val collectViewModel by viewModels<BE>()
    ...
    private fun initRecyclerView() {
        binding.rvMyArticle.run {
            layoutManager = LinearLayoutManager(this@E)
