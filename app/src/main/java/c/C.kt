...
class C : BaseVMActivity<BG, ActivityIntegralBinding>() {

    private val integralViewModel by viewModels<BG>()
    private val mainViewModel by viewModels<BI>()
     ...
     * 开启积分动画
     */
    private fun startAnim(coinInfo: T) {
    ...
    private fun initRecyclerView() {
        binding.rvIntegralList.run {
            layoutManager = LinearLayoutManager(this@C)
