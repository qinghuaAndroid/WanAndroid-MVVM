 ...
 */
@HiltViewModel
class BG @Inject constructor(private val mRepository: BF) : BaseViewModel() {

    private val _uiState = MutableLiveData<ListUiState<CB>>()
    val uiState: LiveData<ListUiState<CB>>
        get() = _uiState
