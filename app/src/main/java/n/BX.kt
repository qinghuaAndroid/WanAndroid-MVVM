 ...
 */
@HiltViewModel
class BX @Inject constructor(private val mRepository: BW) : BaseViewModel() {

    private val _uiState = MutableLiveData<BaseUiState<MutableList<CF>>>()
    val uiState: LiveData<BaseUiState<MutableList<CF>>>
        get() = _uiState
    ...
    private fun emitUiState(
        ...
        showSuccess: MutableList<CF>? = null
    ) {
