...
class G : BaseVMActivity<BN, ActivitySearchBinding>(){

    private val searchViewModel by viewModels<BN>()
    ...
    private fun showHotSearchData(hotSearchDatas: MutableList<CA>) {
    ...
    private fun showHistoryData(historyBeans: List<CE>) {
