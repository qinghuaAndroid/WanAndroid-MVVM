...
@HiltViewModel
class BI @Inject constructor(private val mRepository: BH) : BaseViewModel() {

    private val _uiState = MutableLiveData<BaseUiState<CG>>()
    val uiState: LiveData<BaseUiState<CG>>
        get() = _uiState
