package com.wan.baselib.log;

import com.wan.baselib.log.sdk.LogBase;
import com.wan.baselib.log.sdk.wrapper.NimLog;
import com.wan.baselib.storage.ExternalStorage;

public class LogUtil extends NimLog {

    private static final String LOG_FILE_NAME_PREFIX = "app";
